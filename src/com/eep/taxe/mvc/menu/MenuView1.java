...
public class MenuView1 extends JFrame {
	...
	public MenuView1() {			
		...
		quitbuttonbg.setIcon(new ImageIcon(getClass().getResource("src/resources/menuview img/btbg.jpg")));
		...
		enterbuttonbg.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		...
		EnterGamebg.setIcon(new ImageIcon("src/resources/menuview img/B1a-Railroad Tracks(1).jpg"));
		...
		label_1.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		...
		label_3.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		...
		label_5.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		...
		label_7.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		...
		Mainmenubg.setIcon(new ImageIcon("src/resources/menuview img/B1a-Railroad Tracks(1).jpg"));
		...
		Creditsbg.setIcon(new ImageIcon("src/resources/menuview img/C_D(g)-Railroad Tracks.jpg"));
		...
		HTPbg.setIcon(new ImageIcon("src/resources/menuview img/C_D(g)-Railroad Tracks.jpg"));
		...
		label_19.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		...
		label_21.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		label_21.setBounds(593, 462, 140, 36);
		Connect.add(label_21);
		
		JLabel Connectbg = new JLabel("");
		Connectbg.setIcon(new ImageIcon("src/resources/menuview img/connect - Tunnel.jpg"));
		...
		label_15.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		...
		label_16.setIcon(new ImageIcon("src/resources/menuview img/btbg.jpg"));
		...
		CreatGamebg.setIcon(new ImageIcon("src/resources/menuview img/connect - Tunnel.jpg"));
		...
		Waitingingbg.setIcon(new ImageIcon("src/resources/menuview img/connect - Tunnel.jpg"));
