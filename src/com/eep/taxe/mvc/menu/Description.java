...
public class Description extends JFrame {
	...
	public Description() {			
		...
		JLabel lblC = new JLabel("How To Play", SwingConstants.CENTER);
		...
		background.setIcon(new ImageIcon("C:\\Users\\yd695\\AppData\\Local\\Microsoft\\Windows\\Temporary Internet Files\\Content.IE5\\EGXEZJH4\\C_D(g)-Railroad_Tracks[1].jpg"));
